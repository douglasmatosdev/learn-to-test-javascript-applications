...
describe('Cart', () => {
  ...
  describe('checkout()', () => {
    ...
    it('should an object with the total and the list of items when summary() is called', () => {
      cart.add({
        product,
        quantity: 5,
      });
  ...
  describe('Special conditions', () => {
    ...
    it('should NOT apply quantity discount for even quantities when condition it not met', () => {
      const condition = {
        quantity: 2,
      };
